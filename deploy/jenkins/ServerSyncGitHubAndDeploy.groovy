pipeline {
  ...
  parameters {
    ...
    booleanParam(name: 'DEPLOY_WHEN_UNCHANGED', defaultValue: false, description: '两端已一致时，是否仍触发一次 Server 发布。')
  }
  ...
  environment {
    ...
    DIRECT_DEPLOY_JOB = 'WeavePress/WeavePressServer'
  }
      ...
      steps {
        script {
          ...
          build job: env.DIRECT_DEPLOY_JOB, wait: false, parameters: [
            ...
            string(name: 'TRIGGER_REPO', value: 'server-sync')
          ]
        }
      }
    }
